<template>
    <div class="flex flex-col flex-1 items-center">
        ...
        <div v-if="route.query.preview" class="text-white p-4 bg-weather-secondary w-full text-center">
            <p>You are currenlty previewing this city, click the "+" icon to start tracking this city</p>
        </div>
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-white">
                ...
                <div
                    class="flex gap-10 overflow-x-scroll scrollbar-thin scrollbar-thumb-weather-secondary scrollbar-track-white-700  ">
...
const getWeatherData = async () => {
    try {
        const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=${ApiKey}&units=metric`)
